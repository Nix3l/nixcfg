# bleeding-edge quickshell package
# taken from https://github.com/quickshell-mirror/quickshell/blob/master/default.nix
# pinned to commit https://github.com/quickshell-mirror/quickshell/commit/d6122277409783377059be6399004eb090a6008e

{
  ...
  unwrapped = stdenv.mkDerivation {
    ...
    src = fetchFromGitea {
      ...
      hash = "sha256-KWU38p8zEtgFOL5KZoWeqWVv27uBFLX3N+Ih+TFs9/0=";
    };
